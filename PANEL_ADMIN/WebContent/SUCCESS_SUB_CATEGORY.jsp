<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="COM.DAO.DAO_SUB_CATEGORY_FILE" %>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">SUB_CATEGORY_TABLE</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered  table-dark">
                                    ...
                                    <tbody>
                                	<%
										DAO_SUB_CATEGORY_FILE ed = new DAO_SUB_CATEGORY_FILE();
										List<BEAN_SUB_CATEGORY_FILE> list =ed.getAllInfo();

										for(BEAN_SUB_CATEGORY_FILE info: list)
										{
									%>
									<tr>
										<td>
											<% out.println(info.GET_SUB_CATEGORY_ID()); %>
										</td>
										<td>
										...
										<td>
											<form action="SUB_CATEGORY_ONE" method="post">
												<input type="hidden" name="id" value="<%=info.GET_SUB_CATEGORY_ID()%>">
