...
%>
<%
	BEAN_CATEGORY_FILE one = (BEAN_CATEGORY_FILE)request.getAttribute("category");
%>
            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header" style="text-align:center;">
                        <strong class="card-title">UPDATE_CATEGORY TABLE</strong>
                    </div>
                              ...
                              <tbody>
									...
									<form action="CATEGORY_ONE" method="post">
										<td style="border-color: blue;text-align: center;">
											<!-- <form action="CATEGORY_ONE" method="post"> -->
											<input type="number" name="id1" id="id1" value=<%=one.GET_CATEGORY_ID()%>>
											<!-- </form> -->
										</td>
									
										<td style="border-color: blue;text-align: center;">
											<!-- <form action="CATEGORY_ONE" method="post"> -->
												<input type="text" name="name1" id="name1"  value=<%=one.GET_CATEGORY_NAME()%>>
											<!-- </form> -->
										</td>
										<td style="border-color: blue;text-align: center;">
