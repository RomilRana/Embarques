<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="COM.BEAN.BEAN_SUB_CATEGORY_FILE" %>
...
%>
<%
	BEAN_SUB_CATEGORY_FILE one = (BEAN_SUB_CATEGORY_FILE)request.getAttribute("sub_category");
%>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Update Sub_Category</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-header" style="text-align:center;">
                        <strong class="card-title">UPDATE_SUB_CATEGORY TABLE</strong>
                    </div>
                              ...
                              <tbody>
									...
									<form action="SUB_CATEGORY_ONE" method="post">
										<td style="border-color: blue;text-align: center;">
											...
											<input type="text" name="id" id="id1" value=<%=one.GET_SUB_CATEGORY_ID()%>>
											
										</td>
									
										<td style="border-color: blue;text-align: center;">
											
												<input type="text" name="name1" id="name1" value=<%=one.GET_SUB_CATEGORY_NAME()%>>
