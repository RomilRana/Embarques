			...
			<nav class="nav-menu">
				<ul class="menu-list" style="border:3px solid black !important;">
					...
					<ul class="dropdown" style="border:3px solid black !important;">
						...
						<li style="border-bottom:3px solid black !important;"><a class="active" href="LOGIN_CONTROL_TRANSPORTER?page=Change Password">Change Password</a></li>
								...
								<div class="login-html">
						                <div class="text-center" >
						                  <h3><i style="color:white" class="fa fa-lock fa-4x"></i></h3>
						                    ...
						                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="PROFILE_ONE"  name="myform" onsubmit="return validateform()">
