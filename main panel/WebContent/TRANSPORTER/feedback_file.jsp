...
<body>
	...
	<div id="container">
			...
			<div class="logo">
				<a href="LOGIN_CONTROL_TRANSPORTER?page=Home"><img src="resources/images/login.png" alt="" height="150" width="300"></a>
			</div>
			...
			<nav class="nav-menu">
				<ul class="menu-list" style="border:3px solid black !important;">
					...
					<li><a class="active" href="LOGIN_CONTROL_TRANSPORTER?page=View Package Order">View Package Order</a></li>
					</ul>
					</li>
		...
		<div id="content">
				...
				<section class="contact-section">
					<div class="container">
						<div class="row">
						<div class="col-sm-12">
							<div class="feed_back-info">
								<form action="feedback_transporter" method="post" id="contact-form" id="contact-form">
									<label class="form-control">USER MAIL:</label>
									<input class="form-control" name="trans_mail" id="cust_mail" type="text">   <br>
									
									<label class="form-control">MESSAGE:</label>
									<textarea class="form-control" name="message" id="message" placeholder="Message" rows="4" cols="50"></textarea> <br><br>
								
									<input type="submit" class="btn btn-primary" name="action" value="submit" id="submit">		
								</form>
							</div>
						</div>
					</div>
