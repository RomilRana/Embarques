...
<%
	...
	if(hi!=null)
	{
		for(Cookie hello : hi)
		{
			if(hello.getName().equals("trans_email"))
			{
				uname=hello.getValue();
			}
			if(hello.getName().equals("trans_password"))
			{
						                ...
						                <div class="text-center" >
						                 <h3><i style="color:white" class="fa fa-user fa-4x"></i></h3>
						                  <h2 class="text-center" style="color:white">Sign In</h2>
						                    ...
						                    <form id="contact-form" id="contact-form"  name="myform" method="post" action="LOG_TWO" onsubmit="return validateform()">
						    
						                      <div class="form-group">
						                        <div class="input-group">
						                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
						                          <input id="trans_email" name="trans_email" placeholder="email address" class="form-control"  type="email" value="<%=uname%>">
						                        </div><br>
						                        <div class="input-group">
						                          <span class="input-group-addon"><i class="glyphicon glyphicon-lock color-blue"></i></span>
						                          <input id="trans_password" name="trans_password" placeholder="password" class="form-control"  type="password" value="<%=password %>">
