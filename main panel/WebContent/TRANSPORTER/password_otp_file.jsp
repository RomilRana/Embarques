		...
		<div id="content">
				...
				<section class="contact-section">
					<%
						...
						%>
							<%-- <form id="contact-form" id="contact-form"  name="myform" method="post" action="VERIFY_OTP_SERVLET" onsubmit="return validateform()">
								...
								<div class="login-html">
						                <div class="text-center" >
						                  ...
						                  <p style="color:white">Please enter the 4-digit verification code we sent via Mail:.</p>
						                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="VERIFY_OTP_SERVLET">
						                      ...
						                      <div class="form-group">
						                        <div class="input-group">
						                          ...
						                          <input type="hidden" name="email" value=<%=one.GET_TRANSPORTER_NAME()%>><br>
						                        </div>
						                      </div>
						                      <div class="form-group">
