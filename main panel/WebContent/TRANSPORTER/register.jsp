								...
								<div class="login-html">
						                <div class="text-center" >
						                  ...
						                  <h2 class="text-center" style="color:white">Register</h2>
						                    ...
						                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="TRANS_ONE" onsubmit="return validateform()">
						                      ...
						                      <div class="form-group">
						                        ...
						                        <div class="input-group">
						                          <span class="input-group-addon"><i class="glyphicon glyphicon-pencil color-blue"></i></span>
						                          <input id="company_name" name="company_name" placeholder="Company_name" class="form-control"  type="text" required>
						                        </div><br>
						                        <div class="input-group">
						                          <span class="input-group-addon"><i class="glyphicon glyphicon-pencil color-blue"></i></span>
						                          <input id="pincode" name="pincode" placeholder="pincode" class="form-control"  type="text">
						                        </div><br>
						                        <div class="input-group">
