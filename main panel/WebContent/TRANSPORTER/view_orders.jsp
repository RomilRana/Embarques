							...
							%>
									...
									<tr style="background-color:  #e8e8e8 ;border-top: 2px solid black !important;font-weight: bolder !important;">
										...
										<form action="QUOTE_TWO" method="post">
											...
											<input type="hidden" name="id1" value="<%=info.GET_TRANS_ID()%>" readonly>
											<%
											Connection cn = CONNECT_FILE.sqlConnection();
											String query = "select * from order_tab where quote_id=? and delivered=0";
											
											
											PreparedStatement ps = cn.prepareStatement(query);
											ps.setInt(1,info.GET_QUOTE_ID());
											ResultSet rs = ps.executeQuery();
											if(rs.next())
											{ 
											%>
										...
										<form action="QUOTE_TWO" method="post">
											...
											String query1 = "select * from order_tab where quote_id=? and dispatch=0";
											
											
											PreparedStatement ps1 = cn1.prepareStatement(query1);
											ps1.setInt(1,info.GET_QUOTE_ID());
										...
										<form action="cancel.jsp" method="post">
											...
											String query2 = "select * from order_tab where quote_id=? and dispatch=0";
											
											
											PreparedStatement ps2 = cn2.prepareStatement(query2);
											ps2.setInt(1,info.GET_QUOTE_ID());
