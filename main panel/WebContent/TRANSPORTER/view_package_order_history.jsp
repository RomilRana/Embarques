	...
	<div id="container">
			...
			<nav class="nav-menu">
				<ul class="menu-list" style="border:3px solid black !important;">
					...
					<li style="border-bottom:3px solid black !important;"><a class="active" href="LOGIN_CONTROL_TRANSPORTER?page=View Package Orders History">Package Orders History</a></li>
					...
					<div class="container">
						<div class="table-responsive">
							...
							<%
										...
										List<BEAN_PACKAGE_ORDER_FILE> list =ed.getAllInfo2(id);
										if(!list.isEmpty())
										{
