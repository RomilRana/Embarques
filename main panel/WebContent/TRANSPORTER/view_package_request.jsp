...
if(null == session.getAttribute("id"))
{
	 response.setContentType("text/html"); PrintWriter pw = response.getWriter();
	  pw.println("<script>");
	  pw.println("var name=\"page=View Package Request\"; \r\n" + 
		...
		<!-- Header
			...
			<nav class="nav-menu">
				<ul class="menu-list" style="border:3px solid black !important;">
					...
					<li style="border-bottom:3px solid black !important;"><a class="active" href="LOGIN_CONTROL_TRANSPORTER?page=View Package Request">View Package Request</a></li>
		...
		<div id="content">
				...
				<section class="contact-section" style="overflow-x: auto;">
					<div class="container" >
							...
							List<BEAN_PACKAGE_FILE> list =ed.getAllInfo1(u_id);
							if(!list.isEmpty())
							{
							%>
                                    ...
                                    <tbody>
										...
										<td>
												...
												<form action="PACKAGE_ORDER_ONE" method="post">
												<input type="hidden" name="id11" value="<%=info.GET_PACKAGE_ID()%>"> 
												 <input type="submit" name="action" value="Confirm" style="background-color: #2ada5f;font-size: 14px;font-weight: bolder;">
												 </form> 
										</td>
										<td>
												...
												<form action="PACKAGE_ORDER_ONE" method="post">
												<input type="hidden" name="id11" value="<%=info.GET_PACKAGE_ID()%>"> 
												 <input type="submit" name="action" value="Decline" style="background-color: #e84038;font-size: 14px;font-weight: bolder;color: white;">
												 </form> 
										</td>
									</tr>
                                    </tbody>
