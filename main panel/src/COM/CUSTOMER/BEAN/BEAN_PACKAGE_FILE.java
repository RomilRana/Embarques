...
public class BEAN_PACKAGE_FILE {
	...
	String image_name,package_name,from_name,to_name,package_description,transporter_name,user_name,description,first_name,last_name,address,company,contact;
