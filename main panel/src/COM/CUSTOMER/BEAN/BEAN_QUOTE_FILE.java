...
public class BEAN_QUOTE_FILE {
	
	private int quote_id,cust_id,user_id,trans_quote_id;
	
	private String user_name,message,reply,date_time,add,company;
	...
	public void SET_TRANS_NAME(String user_name)
	{
		this.user_name=user_name;
	}
