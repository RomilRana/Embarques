...
/**
 * Servlet implementation class LOGIN_CONTROL_CUSTOMER
 */
@WebServlet("/CUSTOMER/LOGIN_CONTROL_CUSTOMER")
public class LOGIN_CONTROL_CUSTOMER extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LOGIN_CONTROL_CUSTOMER() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(page.equals("Forget"))
		{
			request.getRequestDispatcher("forgot_password.jsp").forward(request, response);
		}
		else if(page.equals("Get Quote"))
		{
			request.getRequestDispatcher("get_quote.jsp").forward(request, response);
		}
		...
		else if(page.equals("View Quote"))
		{
			request.getRequestDispatcher("search_quote.jsp").forward(request, response);
		}
		else if(page.equals("Select Quote"))
		{
			request.getRequestDispatcher("select_quote.jsp").forward(request, response);
		}
		else if(page.equals("Search"))
		{
			request.getRequestDispatcher("search_t.jsp").forward(request, response);
		}
		...
		else if(page.equals("See Packages"))
		{
			request.getRequestDispatcher("select_package.jsp").forward(request, response);
		}
		else if(page.equals("View Packages Orders"))
		{
		...
		else if(page.equals("Mail Error"))
		{
			request.getRequestDispatcher("mail_error.jsp").forward(request, response);
		}
		else if(page.equals("No Reply"))
		{
			request.getRequestDispatcher("no_reply.jsp").forward(request, response);
		}
		...
		else if(page.equals("Send Package Message"))
		{
			request.getRequestDispatcher("send_package_message.jsp").forward(request, response);
		}
		else if(page.equals("View Packages"))
		{
			request.getRequestDispatcher("view_packages.jsp").forward(request, response);
		}
		else if(page.equals("View Quotes"))
		{
			request.getRequestDispatcher("view_quote.jsp").forward(request, response);
		}
		else if(page.equals("View Package Order History"))
		{
			request.getRequestDispatcher("view_package_order_history.jsp").forward(request, response);
		}
		else if(page.equals("View Cancled Orders"))
		{
			request.getRequestDispatcher("view_cancel_order.jsp").forward(request, response);
		}
		else if(page.equals("View Cancled Package Orders"))
		{
			request.getRequestDispatcher("view_cancel_package_orders.jsp").forward(request, response);
		}
		else if(page.equals("Password OTP"))
		{
			request.getRequestDispatcher("password_otp.jsp").forward(request, response);
		}
